...
// el alta completa de cliente (nombre, apellido y documento alcanzan). Es
// un `customers` normal -- si más adelante quiere pedir crédito, se
// completa el resto desde "Editar cliente".
