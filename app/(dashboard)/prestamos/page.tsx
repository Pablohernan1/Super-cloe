...
export default async function LoansPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Préstamos"
        description="Gestión y seguimiento de préstamos otorgados"
      >
        <Link href="/prestamos/simulacion">
          <Button>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Total: {loans?.length || 0} préstamos registrados
          </CardDescription>
        </CardHeader>
        <CardContent>
                  ...
                  {loans.map((loan: any) => (
                    <TableRow key={loan.id}>
                      ...
                      <TableCell className="text-right">
                        ${(loan.principal_amount || 0).toLocaleString('es-AR')}
                      </TableCell>
                      ...
                      <TableCell className="text-right font-medium">
                        ${(loan.total_amount || 0).toLocaleString('es-AR')}
                      </TableCell>
                      <TableCell>
